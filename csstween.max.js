...
(function(root, factory) {
    if (typeof define === 'function' && define.amd) {
        define(['exports'], function(exports) {
            root.CTM = root.CssTweenMax = factory(root, exports);
        });
    } else if (typeof exports !== 'undefined') {
        factory(root, exports);
    } else {
        root.CTM = root.CssTweenMax = factory(root, {});
    }

}(this, function(root, CTM) {

    var previousCssTweeen = root.CTM;

    CTM.VERSION = '0.1.0';

    CTM.noConflict = function() {
        root.CTM = previousCssTweeen;
        return this;
    };

    // --------------------------------------------------------------------extend
    CTM.extend = function(obj) {
        for (var prop in obj) {
            this[prop] = obj[prop];
        }
    };
    ...
    CTM.browserPrefix = function(str) {
        if (arguments.length) {
    ...
    CTM.extend({
        ...
        _endHandler:function(obj){
            ...
            for(var j in _endEvents){
                CTM._removeEventHandler(obj.dom, _endEvents[j]);
            }
            obj.fun();
        },
